...
public class OI  {
	...
	public OI() {
		...
		*/
		...
		new JoystickButton(OI.rightJoystick, 1).whenPressed(new ShootCommand(ShooterSide.RIGHT));
		new JoystickButton(OI.leftJoystick, 1).whenPressed(new ShootCommand(ShooterSide.LEFT));
